        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 mb-32 items-center">
          <div className="order-2 lg:order-1 space-y-8">
            ...
            <div className="flex items-baseline space-x-4">
              <span className="text-xl font-light text-neuro-gold">
                $180.00
              </span>
            ...
            <p className="text-gray-600 font-light leading-relaxed">
              A bespoke formulation created exclusively for you. Based on our AI
              analysis of your personality and preferences, the machine will
              dispense a unique ratio of our master accords. No two formulas are
              exactly alike.
            </p>
